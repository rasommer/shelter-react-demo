 ...
 */
function stableSort<Donation>(
  array: readonly Donation[],
  comparator: (a: Donation, b: Donation) => number
) {
  const stabilizedThis = array.map(
    (el, index) => [el, index] as [Donation, number]
  );
...
const DonationTable = (props: DonationTableProps) => {
  ...
  const [orderBy, setOrderBy] = React.useState<keyof Donation>("name");
